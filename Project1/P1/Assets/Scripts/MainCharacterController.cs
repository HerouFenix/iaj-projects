...
public class MainCharacterController : MonoBehaviour {
    ...
    public float IGNORE_DISTANCE = 10.0f;
    public float CHARACTER_SIZE = 2.5f;
    public float OBSTACLE_SIZE = 2.5f;
    ...
    public void InitializeMovement(GameObject[] obstacles, List<DynamicCharacter> characters)
    {
        ...
        this.rvoMovement = new RVOMovement(this.patrolMovement, characters.Select(c => c.KinematicData).ToList(), obstacles.ToList(), this.character.KinematicData)
        {
            Character = this.character.KinematicData,
            MaxAcceleration = MAX_ACCELERATION,
            MaxSpeed = MAX_SPEED,
