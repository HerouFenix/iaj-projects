...
public class SceneManager : MonoBehaviour
{
    ...
    private MainCharacterController CreateCharacter()
    {
        ...
        // SET VARIABLES
        characterController.MAX_ACCELERATION = 50.0f;
        characterController.MAX_SPEED = 10.0f;
        characterController.DRAG = 0.1f;
        characterController.MAX_LOOK_AHEAD = 10.0f;
        characterController.AVOID_MARGIN = 7.0f;

        characterController.MAX_TIME_LOOK_AHEAD = 2.0f;
        characterController.COLLISION_RADIUS = 2.0f;

        characterController.IGNORE_DISTANCE = 10.0f;
        characterController.CHARACTER_SIZE = 2.5f;
        characterController.OBSTACLE_SIZE = 6f;
